        ...
        <div className='container mx-auto flex px-5 py-16 md:flex-row flex-col items-center'>
          <div className='lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center'>
            ...
            <p className='mb-8 leading-relaxed text-white'>
              Temukan perawat dan layanan medis yang tepat untuk kebutuhan
              kesehatan di mana pun Anda berada.
            </p>
            <div className='flex w-full md:justify-start justify-center items-end'>
              <div className='relative mr-4 md:w-full lg:w-full xl:w-1/2 w-2/4'>
                ...
                <input
                  ...
                  id='hero-field'
                  name='hero-field'
                  className='w-full bg-gray-100 rounded bg-opacity-50 focus:ring-2 focus:ring-indigo-200 focus:bg-transparent focus:border-indigo-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out'
                />
              </div>
              <button className='inline-flex text-white bg-orange border-0 py-2 px-6 focus:outline-none hover:bg-orange-600 rounded text-lg'>
                Button
              </button>
            </div>
            ...
            <div className='flex lg:flex-row md:flex-col mt-9'>
